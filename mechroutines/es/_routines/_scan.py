...
def run_scan(zma, spc_info, mod_thy_info, thy_save_fs,
    ...
    if constraint_dct is None:
        ...
        ioprinter.debug_message('coord_grids test:', coord_grids)
                ...
                if opt_zma is not None and opt_geo is not None:
                    ...
                    if connected:
                        ...
                        ioprinter.warning_message(
                            'Structure seems to be unstable...')
                    ...
                    ioprinter.warning_message('No output found in file')
...
def _write_traj(ini_locs, scn_save_fs, mod_thy_info, locs_lst):
    ...
    ioprinter.info_message(
        "Updating scan trajectory file at {}".format(traj_path))
...
def run_two_way_scan(ts_zma, ts_info, mod_var_scn_thy_info,
    ...
    ioprinter.info_message('Saving the scans...', newline=1)
    if constraint_dct is None:
        save_scan(
            scn_run_fs=scn_run_fs,
            scn_save_fs=scn_save_fs,
