...
def run_irc(zma, irc_job, coord_name, run_fs, ini_scn_save_fs,
    ...
    if not _irc_ran(ini_scn_save_fs, coord_name, irc_job):
        ioprinter.info_message('No IRC calculation in save filesystem')
    ...
    if need_irc:
        ioprinter.info_message('Running IRC calculation')
        es_runner.run_job(
            job=irc_job,
        ...
        ioprinter.info_message('Skipping IRC calculation')
...
def save_irc(irc_job, coord_name,
    ...
    if opt_success is not None:
        ...
        for idx, val in enumerate(coord_vals):
            ...
            ioprinter.debug_message('irc locs', locs)
...
def _irc_ran(ini_scn_save_fs, coord_name, irc_job):
    ...
    ioprinter.debug_message('irc coord name', coord_name)
