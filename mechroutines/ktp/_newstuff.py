...
def prompt_dissoctiation_ktp_dct(rad_name, modeltype,
    ...
    """ Evaluate the prompt dissociation k(T,P) values.
        ...
        :type rad_name: str
        :param modeltype: statistical energy distribution model for hot radical
        :type modeltype: str
    ...
    # 1b. READ ke_ped.out file and extract the energy density of each fragment
    ...
    # 3. DERIVE T,P DEP PROD BRANCHING FRACTIONS; decide which species to keep
