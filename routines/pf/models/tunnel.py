...
#                 orb_restr = filesys.inf.orbital_restriction(
#                     ts_info, ene_thy_level)
...
#
#
# def write_rpht_sct_input(geoms, grads, hessians, coord_proj='cartesian'):
#     """ Read the struct info for each point alon
#     """
#     return projrot_io.writer.rpht_input(
#         geoms, grads, hessians,
#         saddle_idx=11, rotors_str='', coord_proj=coord_proj)
#
#
# def write_rpht_sct_coord_en(rxn_path_coords, rxn_path_energies):
#     """ test projrot_io.writer.rpht_path_coord_en
#     """
#     return projrot_io.writer.rpht_path_coord_en(
