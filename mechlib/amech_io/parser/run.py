...
TSK_KEY_DCT = {
    ...
    'hr_scan': (('spc', 'ts'),
                BASE + ('tors_model', 'resamp_min', 'cnf_range',)),
    ...
    'hr_reopt': (('spc', 'ts'),
                 BASE + ('tors_model', 'hrthresh', 'cnf_range',)),
    ...
    'coeffs': (('spc', 'ts'), ()),
    # KTP/Therm
    'write_mess': ((), ('kin_model', 'spc_model',
                        'overwrite', 'lump_wells', 'cnf_range')),
    'run_mess': ((), ('kin_model', 'spc_model',
                      'nprocs', 'inpname', 'cnf_range')),
