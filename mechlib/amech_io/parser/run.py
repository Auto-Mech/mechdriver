...
from mechlib.amech_io.parser.keywords import RUN_INP_KEY_DCT
from mechlib.amech_io.parser.keywords import RUN_SUPPORTED_KEYWORDS
...
def read_print_tsks(job_path):
    ...
    prnt_tsks_str = prnt_tsks_block(run_str)
